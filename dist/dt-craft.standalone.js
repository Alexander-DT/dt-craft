 ...
 *  For a host page that has no markup of its own (a blank Webflow page).
 *  Once the sections are rebuilt natively in Webflow, use dt-craft.js instead.
 */
(function () {
  ...
  function boot() {
    // only inject if the hooks are genuinely absent, so this file is safe
    // to leave in place while sections get rebuilt natively one at a time
    if (document.getElementById("vp")) return;
    var host = document.createElement("div");
    host.id = "dt-craft-root";
