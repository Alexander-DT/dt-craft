...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/Alexander-DT/dt-craft@v1.0.2/dist/dt-craft.css">
```

**Project Settings → Custom Code → Before `</body>`:**

```html
<script src="https://cdn.jsdelivr.net/gh/Alexander-DT/dt-craft@v1.0.2/dist/dt-craft.js" defer></script>
```
